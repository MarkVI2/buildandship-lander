...
export default function Home() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "We are working on a new project that will be revealed soon.",
      link: "#",
    },
  ];
  ...
  const aboutText =
    "We are a collective of college friends turned entrepreneurs, driven by our passion for innovation and technology. Based in Hyderabad, we're on a mission to build and ship products that make a difference.";
  ...
  return (
    <>
      {isLoading && (
        <LoadingScreen onTransitionStart={() => setShowTransition(true)} />
      )}
      {showTransition && (
      ...
      {showLogo && (
        <>
          ...
          <div className="min-h-screen bg-black relative z-10 mt-[65vh]">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-24 border-t border-white/10 bg-black/90">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-8 text-center px-4">
                  Meet Us In Person
                </h2>

                <div className="bg-white/5 rounded-2xl p-4 sm:p-8 w-full max-w-3xl backdrop-blur">
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-4 sm:gap-8">
                    <div className="flex-1 w-full">
                      <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">
                        Weekend Pop-up Events
                      </h3>
                      <p className="text-white/80 text-base sm:text-lg mb-4 sm:mb-6">
                        Join us every weekend in Hyderabad for casual meetups
                        where we discuss tech, startups, and innovation. Whether
                        you're a fellow entrepreneur, student, or just curious
                        about what we do - you're welcome!
                      </p>
                      <div className="space-y-2 sm:space-y-3 text-white/70">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm sm:text-base"> TBA </span>
                        </div>
                        <div className="flex items-center gap-2">
                          <svg
                            className="w-4 h-4 sm:w-5 sm:h-5"
            ...
            <div
              id="contact"
              className="max-w-6xl mx-auto px-6 py-24 border-t border-white/10 bg-[#8BA5FF]"
            >
              ...
              <div className="flex flex-col items-center gap-8 text-center">
                <p className="text-white/80 text-xl max-w-2xl">
                  Want to discuss your next project or interested in working
                  with us? We're always open to meeting new people and exploring
