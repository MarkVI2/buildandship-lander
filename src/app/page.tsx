                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="flex-1">
                    ...
                    <p className="text-white/80 text-lg mb-6">
                      Join us every weekend in Hyderabad for casual meetups where we discuss tech, startups, and innovation. Whether you're a fellow entrepreneur, student, or just curious about what we do - you're welcome!
                    </p>
            ...
            <div id = "contact"className="max-w-6xl mx-auto px-6 py-24 border-t border-white/10 bg-[#8BA5FF]">
              ...
              <div className="flex flex-col items-center gap-8 text-center">
                <p className="text-white/80 text-xl max-w-2xl">
                  Want to discuss your next project or interested in working with us? We're always open to meeting new people and exploring exciting opportunities.
                </p>
